...
class _ResultsPageHandler:
    ...
    async def _get_page(session: httpx.AsyncClient, semester_id: str) -> SemesterResult:
        ...
        credits_total = credit_parts[1].strip() if len(credit_parts) > 1 else credits_earned # Fix for cases where total credits are not provided
        ...
        for container in course_containers:
            ...
            if not assessment_bar: continue

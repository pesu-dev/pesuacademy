...
class _ProfilePageHandler:
    ...
    async def _get(session: httpx.AsyncClient) -> Profile:
        ...
        Args:
            session (httpx.AsyncClient): """This module handles fetching and parsing the student Profile page from the PESU Academy website."""
...
An authenticated HTTP client session.
